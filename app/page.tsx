      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            ...
            <button className="mt-6 w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm font-semibold">
              Get Started
            </button>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            ...
            <button className="mt-6 w-full bg-purple-600 text-white py-2 rounded-lg hover:bg-purple-700 transition-colors text-sm font-semibold">
              Convert Now
            </button>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            ...
            <button className="mt-6 w-full bg-green-600 text-white py-2 rounded-lg hover:bg-green-700 transition-colors text-sm font-semibold">
              Calculate
            </button>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            ...
            <button className="mt-6 w-full bg-orange-600 text-white py-2 rounded-lg hover:bg-orange-700 transition-colors text-sm font-semibold">
              Create
            </button>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-blue-100 text-sm">
                AI-powered tools deliver professional documents in seconds
              </p>
            </div>
            <div className="text-center">
              <div className="text-5xl mb-3">💰</div>
              ...
              <p className="text-blue-100 text-sm">
                No need to hire designers, accountants, or use multiple tools
              </p>
            </div>
            <div className="text-center">
              <div className="text-5xl mb-3">🌍</div>
              ...
              <p className="text-blue-100 text-sm">
                Works for registered and non-registered businesses worldwide
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <button className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow text-center border border-gray-100">
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-gray-600 mb-8 text-lg">
            Start using our tools for free. No credit card required.
          </p>
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <button className="bg-white text-gray-700 px-8 py-4 rounded-lg font-semibold hover:bg-gray-50 transition-colors border-2 border-gray-300 text-lg">
              View Demo
            </button>
          </div>
        </div>
