      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            ...
            <p className="text-gray-600 mb-4 text-sm">
              AI-powered proposals, contracts, and invoicing with payment tracking
            </p>
            ...
            <Link href="/tools/documents" className="mt-6 w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm font-semibold text-center block">
              Get Started
            </Link>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            ...
            <p className="text-gray-600 mb-4 text-sm">
              Convert, merge, compress, and edit documents instantly
            </p>
            <ul className="space-y-2 text-sm text-gray-600">
              <li>• Word to PDF</li>
              <li>• PDF Merger</li>
            ...
            <Link href="/tools/documents" className="mt-6 w-full bg-purple-600 text-white py-2 rounded-lg hover:bg-purple-700 transition-colors text-sm font-semibold text-center block">
              Convert Now
            </Link>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            ...
            <p className="text-gray-600 mb-4 text-sm">
              Calculators and tools to price and manage your business
            </p>
            <ul className="space-y-2 text-sm text-gray-600">
            ...
            <Link href="/tools/calculators/tax" className="mt-6 w-full bg-green-600 text-white py-2 rounded-lg hover:bg-green-700 transition-colors text-sm font-semibold text-center block">
              Calculate
            </Link>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            ...
            <p className="text-gray-600 mb-4 text-sm">
              Templates and generators for professional communication
            </p>
            <ul className="space-y-2 text-sm text-gray-600">
            ...
            <Link href="/tools/documents" className="mt-6 w-full bg-orange-600 text-white py-2 rounded-lg hover:bg-orange-700 transition-colors text-sm font-semibold text-center block">
              Create
            </Link>
          </div>
        ...
        <div className="bg-gray-50 rounded-xl p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link href="/tools/documents" className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow text-center border border-gray-100 block">
              <div className="text-3xl mb-2">✉️</div>
              <div className="font-semibold text-sm text-gray-800">Document Tools</div>
            </Link>
          </div>
        </div>
        ...
        <div className="text-center mt-12">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link href="/tools/documents" className="bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors text-lg">
              Start Free Trial
            </Link>
        ...
        <div className="mt-16 text-center text-sm text-gray-500">
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            <span className="inline-flex items-center gap-1"><span className="w-2 h-2 bg-green-500 rounded-full"></span>InvoiceAI</span>
            <span className="inline-flex items-center gap-1"><span className="w-2 h-2 bg-green-500 rounded-full"></span>ProposalAI</span>
            <span className="inline-flex items-center gap-1"><span className="w-2 h-2 bg-green-500 rounded-full"></span>ContractAI</span>
            <span className="inline-flex items-center gap-1"><span className="w-2 h-2 bg-green-500 rounded-full"></span>DocumentTools</span>
            <span className="inline-flex items-center gap-1"><span className="w-2 h-2 bg-green-500 rounded-full"></span>PaymentAI</span>
          </div>
        </div>
      </div>
    </main>
