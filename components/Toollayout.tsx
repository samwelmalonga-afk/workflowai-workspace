export default function ToolLayout({ title, description, children, backLink = '/dashboard', backText = 'Back to Dashboard' }: { title: string; description: string; children: React.ReactNode; backLink?: string; backText?: string }) {
  return (
